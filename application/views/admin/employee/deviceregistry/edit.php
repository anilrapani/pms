            ...
            <div class="col-md-10">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" action="<?php echo base_url() ?>admin/employee/editdeviceregistry" method="post" id="editCompany" role="form">
                        <div class="box-body">
                              <div class="row">
                                <div class="col-md-6">                                
                                  ...
                                  <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" id="ipaddress" name="ipaddress" maxlength="128" value="<?php echo $resultInfo->ipaddress; ?>">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="user_id">Device Belong to</label>
                                        <select class="form-control required" id="user_id" name="user_id">
                                            ...
                                            if(!empty($userListArray))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $user->id; ?>" <?php if($user->id == $resultInfo->user_id) {echo "selected=selected";} ?> ><?php echo $user->name.' - '.$user->id; ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
