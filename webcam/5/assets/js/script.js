...
//      });
 ...
 navigator.getMedia = navigator.getUserMedia;
    if(!navigator.getUserMedia){
        ...
        navigator.getUserMedia(
            ...
            function(stream){
     var getUserMedia = c => {
            var face = c.camerastream && c.camerastream.facingMode;
            ...
            delete c.camerastream.facingMode;
            ...
            .then(devices => {
              ...
              if (back) {
                c.camerastream.deviceId = face.exact? { exact: back.deviceId } : { ideal: back.deviceId };
              }
              return navigator.mediaDevices.getUserMedia(c);
            });
          };
 ...
 getUserMedia({ video: { facingMode: "environment" } })
            ...
            .then(camerastream.play())
    .then(camerastream.onplay = function() {
                    showVideo();
                })
