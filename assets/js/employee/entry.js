document.addEventListener('DOMContentLoaded', function () {
    ...
    take_photo_btn.addEventListener("click", function(e){
        ...
        document.getElementsByName("image_vehicle_number_plate")[0].setAttribute("value", snap);
    ...
    take_photo_btn2.addEventListener("click", function(e){
        ...
        document.getElementsByName("image_driving_license_number")[0].setAttribute("value", snap);
