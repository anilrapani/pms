        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>employee/vehicle/add/company"><i class="fa fa-plus"></i> Add New</a>
                </div>
            </div>
        </div>
        <div class="row">
...
<script type="text/javascript">
    ...
    updateStatusUrl = "employee/vehicle/updateVehicleCompanyStatus";
</script>
