...
<!--                        <h3 class="box-title">Print Preview</h3>-->
                        <div class="box-body printTicket" >
                            ...
                            <h4>Entry Date : <span><?php echo date("d- m- Y", strtotime($entryDetails->entry_time, $timeZoneName ='IST')); // date("d- m- Y", strtotime($entryDetails->entry_time, $timeZoneName ='IST'));  ?></span></h4>
                            <h4>Entry Time: <span><?php echo date("H : i : s", strtotime($entryDetails->entry_time, $timeZoneName ='IST')); // date("H : i : s", strtotime(convertTime($entryDetails->entry_time, $timeZoneName ='IST'))); ?></span></h4>
