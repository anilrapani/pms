<div class="content-wrapper">
    ...
    <section class="content">
        <?php   if(!empty($currentReportArray)) { ?>
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>employee/report/currentReportSubmission"><i class="fa fa-gears"></i> Generate Report</a>
                </div>
            </div>
        </div>
        <?php   } ?>
