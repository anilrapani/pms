document.addEventListener('DOMContentLoaded', function () {
    ...
    var video = document.querySelector('#camera-stream'),
     ...
     var mozGetUserMedia = webkitGetUserMedia = getUserMedia = c => {
    ...
    navigator.getMedia = ( getUserMedia({ video: { facingMode: "environment" }, audio: true })
            .then(stream => video.srcObject = stream)
            .catch(e => console.log("manualerror"+e.name + ": "+ e.message)) ||
    navigator.webkitGetUserMedia ||
    navigator.mozGetUserMedia({ video: { facingMode: "environment" }, audio: true })
            .then(stream => video.srcObject = stream)
            .catch(e => console.log("manualerror"+e.name + ": "+ e.message)) ||
