...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="box-header col-md-6">
            ...
            <h1 class="box-title"><i class="fa "></i> <?php echo ($isNewEntry == true)?'Manual Exit':'';  ?></h1>
<!--                    <div class="box-tools">
...
?>
            ...
            <!-- left column -->
            <form role="form" id="addEntry" action="<?php echo base_url() ?>employee/vehicle/addManualExit/<?php echo $entryId; ?>" method="post" role="form" enctype="multipart/form-data">
            <div class="col-md-6">
                <!-- general form elements -->
