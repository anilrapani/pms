                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td><?php if(!empty(trim($record->vehicle_number))){
                                    ...
                                    <a href="#" class="pop">
                                        <img class="imageresource"  class="img-responsive" src="<?php echo base_url() ?>assets/images/upload/numberplate/75/<?php echo $record->image_vehicle_number_plate; ?>" alt="" image_name="<?php echo $record->image_vehicle_number_plate; ?>" >
                                    </a>
                          <?php } ?>
                      </td>
